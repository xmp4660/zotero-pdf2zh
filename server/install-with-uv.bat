...
if %errorlevel%==0 if "%RUN_WARMUP%"=="1" call :run_babeldoc_warmup "%ENV_PATH%" || exit /b 1
...
set "PACKAGES1=pdf2zh==1.9.11 pypdf PyMuPDF flask numpy==2.2.0 toml pdfminer.six==20250416 babeldoc"
