...
新版本v3.0.29 | [旧版本v2.4.3](./2.4.3%20version/README.md)
...
# 2. 下载并解压server文件夹
# 如果server.zip下载失败, 可以直接访问: https://github.com/guaguastandup/zotero-pdf2zh/releases/download/v3.0.29-beta/server.zip 手动下载
