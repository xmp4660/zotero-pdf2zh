...
感谢您对 Zotero PDF2zh 项目的关注！我们欢迎各种形式的贡献。
...
- 💬 加入 [QQ 群](https://github.com/guaguastandup/zotero-pdf2zh)：5群 1064435415（入群答案：github）
...
::: warning 开发注意事项
以下功能项目组正在规划中或已有实现方案，请勿自行开发，以免与项目规划冲突。
:::
